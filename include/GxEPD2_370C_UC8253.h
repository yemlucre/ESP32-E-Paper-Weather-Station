...
#ifndef _GxEPD2_370_CZ78_H_
#define _GxEPD2_370_CZ78_H_

#include "GxEPD2_EPD.h"

class GxEPD2_370C_UC8253 : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const uint16_t power_on_time = 8000; // ms, e.g. 46000us
    static const uint16_t power_off_time = 8000; // ms, e.g. 40000us
    static const uint16_t full_refresh_time = 15000; // ms, e.g. 1005000us or 1486000us
    static const uint16_t partial_refresh_time = 15000; // ms, e.g. 343000us
    // constructor
    GxEPD2_370C_UC8253(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
    ...
    void writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color, bool invert = false, bool mirror_y = false, bool pgm = false);
